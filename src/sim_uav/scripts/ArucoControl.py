...
from sim_uav.srv import goto_aruco, goto_arucoResponse, land_aruco, land_arucoResponse
...
class ArucoNavigationController():
    ...
    def __init__(self):
        ...
        self.markerHeight = 1.0 # Height above the marker
    ...
    def GotoAruco(self, req):
        ...
        zPID = PID(.2, 0.0, 0.05, output_limits=(-0.5, 0.5), setpoint=0.0)
