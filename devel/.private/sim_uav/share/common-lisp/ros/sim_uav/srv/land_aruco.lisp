...
(cl:defmethod cl:initialize-instance :after ((m <land_aruco-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'land_aruco-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sim_uav-srv:<land_aruco-request> is deprecated: use sim_uav-srv:land_aruco-request instead.")))

(cl:ensure-generic-function 'timeOut-val :lambda-list '(m))
(cl:defmethod timeOut-val ((m <land_aruco-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sim_uav-srv:timeOut-val is deprecated.  Use sim_uav-srv:timeOut instead.")
  (timeOut m))
...
(cl:defmethod cl:initialize-instance :after ((m <land_aruco-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'land_aruco-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sim_uav-srv:<land_aruco-response> is deprecated: use sim_uav-srv:land_aruco-response instead.")))
