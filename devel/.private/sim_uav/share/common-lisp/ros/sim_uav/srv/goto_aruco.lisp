...
(cl:defmethod cl:initialize-instance :after ((m <goto_aruco-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'goto_aruco-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sim_uav-srv:<goto_aruco-request> is deprecated: use sim_uav-srv:goto_aruco-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <goto_aruco-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'goto_aruco-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sim_uav-srv:<goto_aruco-response> is deprecated: use sim_uav-srv:goto_aruco-response instead.")))
